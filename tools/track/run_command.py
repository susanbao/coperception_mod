...
command_list =[
    "CUDA_VISIBLE_DEVICES=0 nohup make byter_track_cfk_nlla det_check_path=check/check_loss_two_step_center_rh_ind mode=upperbound nll_threshold=",
    "CUDA_VISIBLE_DEVICES=0 nohup make eval mode=upperbound output_name=center_rh_ind_nll_cfk_",
]
